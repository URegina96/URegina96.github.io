...
<body style="background-image: url(https://static.insales-cdn.com/images/products/1/3042/344419298/9DC88D7B-5C65-4113-A287-7E00D7374601.jpeg);background-repeat: no-repeat; background-position: top center; background-size: 100%; background-attachment: fixed">
    ...
    <ul>
<li><font size="3" color="white" face="serif">"Хороший источник антиоксидантов, которые могут защитить организм от воспалений.</li>
...
<li>Имеет некоторые когнитивные преимущества. Например, полифенолы в меде позитивно влияют на память.</li>"</font>
    </ul>
  <form>
  ...
  <input type="text" name="number" id="number"><br>
    <h1><font size="5" color="white">"Как Вы узнали о нас?</h1>"</font>
<form> <font size="3" color="white">"
  ...
  <input type="checkbox" name="rockabilly">Всегда знал)<br>"</font>
</form>
</form>
  </body>
</html>
